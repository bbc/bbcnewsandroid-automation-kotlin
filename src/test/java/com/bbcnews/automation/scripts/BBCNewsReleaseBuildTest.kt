...
class BBCNewsReleaseBuildTest
{
    ...
    fun testOpenNewsApp() {
        try {
            ...
            try {
                if (commonFunctionKotlin.isElementPresent(androidDriver, By.id("bbc.mobile.news.uk:id/error_retry")))
                {
                    androidDriver.findElement(By.id("bbc.mobile.news.uk:id/error_retry")).click()
    ...
    fun testToCheckTopicsTopStores() {
        try {
            ...
            if (!commonFunctionKotlin.isElementPresent(androidDriver, By.id("bbc.mobile.news.uk:id/menu_follow"))) {
    ...
    fun testCheckReOrderingofTopicsAdded() = try {
        ...
        val england = androidDriver.findElementsById("bbc.mobile.news.uk:id/grab_handle")[0]
        val youtubetopic = androidDriver.findElementsById("bbc.mobile.news.uk:id/grab_handle")[4]
    ...
    fun scrubbingvideoplayback() {
        ...
        commonFunctionKotlin.isElementPresent(androidDriver, By.id("bbc.mobile.news.uk:id/smp_seek_bar"))
    ...
    fun testondemandvideoplyback() {
        try {
            ...
            commonFunctionKotlin.elementDisplayed(androidDriver, androidDriver.findElement(By.id("bbc.mobile.news.uk:id/content_card_title")))
            commonFunctionKotlin.elementDisplayed(androidDriver, androidDriver.findElement(By.id("bbc.mobile.news.uk:id/content_card_last_updated")))
            ...
            assertEquals(videotitle, androidDriver.findElement(By.id("bbc.mobile.news.uk:id/headline_title")).text)
            assertEquals("31 Dec 2018", androidDriver.findElement(By.id("bbc.mobile.news.uk:id/headline_info")).text)
            ...
            while (i < vidoePageObject.videodetailpage_Release.size && i < vidoePageObject.videdetailpagetext.size) {
                ...
                assertEquals(vidoePageObject.videdetailpagetext[i], androidDriver.findElement(By.id(vidoePageObject.videodetailpage_Release[i])).text)
                i++
            }
        } catch (e: AssertionError) {
            throw e
    ...
    fun testRelatedTopicArticle() {
        ...
        assertEquals("Egypt", androidDriver.findElement(By.id("bbc.mobile.news.uk:id/title")).text)
        assertEquals("Add topic", androidDriver.findElement(By.id("bbc.mobile.news.uk:id/menu_follow")).getAttribute("contentDescription"))
        for (i in 0 until basePageObject.topicspageelemnets_Release.size) {
            commonFunctionKotlin.isElementPresent(androidDriver, By.id(basePageObject.topicspageelemnets_Release[i]))
        }
        commonFunctionKotlin.tapButton(androidDriver, basePageObject.backButton, false)
    ...
    fun testArrangeTopicsFromBottomToTop() {
        ...
        val india = androidDriver.findElementsById("bbc.mobile.news.uk:id/grab_handle")[5]
        val europe = androidDriver.findElementsById("bbc.mobile.news.uk:id/grab_handle")[0]
